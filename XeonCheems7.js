...
case 'alive': case 'panel': case 'list': case 'menu': case 'help': case '?': {
            ...
            xeonezy = `╭━━━━━╼⃟݊⃟̥⃝̇𝗕𝗔𝗬𝗠𝗔𝗫 𝗩7݊⃟̥⃝̇݊⃟╾━━━━━╮
┃ ┃♤  ╭━━━━━━━━━━━━━━╮
┃ ┃♤  ┃❏ 𝗛𝗬 : ${pushname} 
┃ ┃♤  ┃❏  ${xeonytimewisher} 
┃ ┃♤  ┃❏ *ɴᴏᴛʜɪɴɢ ᴍᴜᴄʜ ʙʀᴏ*
...
me = m.sender
teks = `*「  ${global.botname} Script 」*\n\nYouTube: ${global.websitex}\nGitHub: ${global.botscript}\n\nHi @${me.split('@')[0]} 👋\nDont forget to donate yeah🍜 👇 https://telegra.ph/file/52b7415eec32c3b3c0e32.jpg`
sendXeonBotIncMessage(from, { 
text: teks,
mentions:[sender],
contextInfo:{
...
case 'add': {
if (!m.isGroup) return replygcxeon(mess.group)
if (!XeonTheCreator) return replygcxeon(mess.admin)
if (!isBotAdmins) return replygcxeon(mess.botAdmin)
...
const { Sticker, createSticker, StickerTypes } = require('wa-sticker-formatter')
        ...
        XeonBotInc.sendMessage(m.chat, {sticker: buffer}, {quoted: m})    
        } else if (/video/.test(mime)) {
            if ((quoted.msg || quoted).seconds > 20) return XeonBotInc.sendMessage(m.chat,{text:'Maximum size is 10 seconds'})
            let media = await quoted.download()
        let sticker = new Sticker(media, {
        ...
        XeonBotInc.sendMessage(m.from, {sticker: stikk}, {quoted: m})
        } else {
            XeonBotInc.sendMessage(m.chat,{text:"❌ Could not find any Image/Video in context"},{quoted:m})
            }
    }
break
